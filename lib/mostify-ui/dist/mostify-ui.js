...
import { ref as e, inject as t, computed as a, defineComponent as n, createVNode as l, Fragment as o, provide as i, reactive as s, watch as r, onBeforeMount as u, onMounted as c, onUnmounted as d, Teleport as p, withDirectives as m, vShow as f, Transition as y, isVNode as v, mergeProps as g, createApp as h } from "vue";
const b = Symbol("muiConfigProvider"), w = n({ name: "MIcon", props: { name: { type: String, default: "" }, size: { type: String, default: "16px" }, color: { type: String, default: "currentColor" } }, setup(e2) {
  const t2 = a(() => `mostifyiconfont m-icon-${e2.name}`);
  return () => l("i", { class: t2.value, style: { color: e2.color, fontSize: e2.size, lineHeight: "inherit" } }, null);
} }), k = n({ name: "MButton", props: { type: { type: String, default: "default" }, size: String, shape: String, disabled: Boolean, loading: Boolean, border: Boolean, light: Boolean, leftIcon: String, rightIcon: String }, emits: ["click", "focus", "blur"], setup(n2, { slots: i2, emit: s2 }) {
  const { btnClass: r2, contentShow: u2, setClickXEvent: c2, btnRef: d2, rippleRef: p2 } = ((n3) => {
    const l2 = e(null), o2 = e(null), i3 = t(b, { size: "" }), s3 = a(() => {
      const e2 = ["m-button"];
  ...
  return () => {
    const e2 = i2.leftIcon ? i2.leftIcon() : n2.leftIcon ? l(w, { name: n2.leftIcon }, null) : "", t2 = i2.rightIcon ? i2.rightIcon() : n2.rightIcon ? l(w, { name: n2.rightIcon }, null) : "";
...
} }), x = n({ name: "MSpace", props: { size: { type: String, default: "" }, layout: { type: String, validator: (e2) => ["x", "y"].includes(e2), default: "x" }, alignItems: { type: String, default: "flex-start" } }, setup(e2, { slots: t2 }) {
...
} }), B = n({ name: "MAnchor", props: { getTarget: { type: Function, default: () => window } }, setup(e2, { slots: a2 }) {
  t(b);
  return () => l("div", null, [a2.default && a2.default()]);
} }), C = n({ name: "MConfigProvider", props: { locale: { type: String, default: "zh-CN" }, size: { type: String, default: "small", validator: (e2) => ["small", "mini", "large"].includes(e2) } }, setup: (e2, { slots: t2 }) => (i(b, e2), () => l(o, null, [t2.default && t2.default()])) }), _ = n({ name: "MBreadcrumb", props: { separator: { type: String, default: "/" }, color: String, activeColor: String }, setup(e2, { slots: t2 }) {
  const n2 = a(() => {
    var _a, _b;
...
}), T = (e2, t2, a2, n2 = 0) => new Promise(async (l2, o2) => {
...
const I = n({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(t2, { slots: n2 }) {
  const o2 = e(null), i2 = e(null), y2 = e(null), v2 = e(false), g2 = s({ top: "0", left: "0", waitChange: false, renderToDom: null }), h2 = e(false);
  let b2 = null;
  ...
  return r(() => t2.trigger, () => {
    ...
    $2();
  }), () => l("div", null, [l("div", { class: "m-dropdown", ref: o2, style: { "pointer-events": g2.waitChange ? "none" : "all" } }, [n2.default && n2.default()]), l(p, { to: "#m-inset__body" }, { default: () => {
    var _a;
    return [w2.value && m(l("div", { class: "m-dropdown__content m-box-shadow", ref: i2, style: { "--top": g2.top, "--left": g2.left, "pointer-events": g2.waitChange ? "none" : "all" } }, [l("div", { class: "m-dropdown__body", ref: y2 }, [n2.content && ((_a = n2.content()) == null ? void 0 : _a.map((e2) => (e2.props = { ...e2.props }, e2)))])]), [[f, v2.value]])];
  } })]);
  ...
  const n2 = t(b, { size: "" });
  return i(b, { size: e2.size || n2.size }), () => l("div", { class: ["m-button-group", "y" === e2.layout ? "m-button-layout-y" : "m-button-layout-x"] }, [a2.default && a2.default()]);
...
const H = n({ name: "MTransition", props: { onEnter: Function, onLeave: Function }, setup: (e2, t2) => () => {
  ...
  return () => {
    ...
    return l(p, { to: t2.target }, { default: () => [l(H, { onEnter: h2, onLeave: b2 }, { default: () => [m(l("div", { class: `m-dialog ${t2.className || ""}`, "data-show": t2.visible, ref: r2, style: { "--m-dialog-mask-color": t2.maskBackgroundColor } }, [l("section", { class: "m-dialog-mask", ref: s2 }, null), l("div", { class: "m-dialog-container", onClick: () => t2.maskHide && y2("cancel") }, [l("div", { style: c2.value }, [l("div", { class: "m-dialog-cover", style: u2.value }, [l("div", { class: "m-dialog-content", onClick: (e3) => e3.stopPropagation() }, [l("div", { class: "m-dialog-content__background", ref: o2 }, null), l("section", { class: "m-dialog-content__wrapper", ref: i2, style: d2.value }, [t2.showClose && l(k, { type: "text", shape: "square", size: "small", class: "m-dialog-content__close", onClick: () => y2("cancel") }, { default: () => [l("svg", { fill: "currentColor", class: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "5090", width: "28", height: "28" }, [l("path", { d: "M504.224 470.288l207.84-207.84a16 16 0 0 1 22.608 0l11.328 11.328a16 16 0 0 1 0 22.624l-207.84 207.824 207.84 207.84a16 16 0 0 1 0 22.608l-11.328 11.328a16 16 0 0 1-22.624 0l-207.824-207.84-207.84 207.84a16 16 0 0 1-22.608 0l-11.328-11.328a16 16 0 0 1 0-22.624l207.84-207.824-207.84-207.84a16 16 0 0 1 0-22.608l11.328-11.328a16 16 0 0 1 22.624 0l207.824 207.84z" }, null)])] }), v3 || t2.title && l("header", { class: "m-dialog__header" }, [l("span", { class: "m-dialog-title" }, [t2.title])]), w2 || l("main", { class: "m-dialog__body" }, [e2 || t2.content]), a2 || (t2.cancelBtnText || t2.okBtnText) && l("footer", { class: "m-dialog__footer" }, [t2.cancelBtnText && l(k, g(t2.cancelBtnProps, { onClick: () => y2("cancel") }), { default: () => [t2.cancelBtnText] }), t2.okBtnText && l(k, g(t2.okBtnProps, { onClick: () => y2("ok") }), { default: () => [t2.okBtnText] })])])])])])])]), [[f, t2.visible]])] })] });
  };
} }), j = (e2) => {
  ...
  const o2 = h(q, { ...j(e2), target: t2, _onClose: async (i3) => {
    var _a, _b;
  ...
  const { inputRef: o2, isFocus: i2, setIsFocus: s2, inputValue: u2 } = ((t3) => {
    const a2 = e(null), n3 = e(false), l2 = e(t3.value || t3.modelValue || "");
  ...
  return n2.expose({ focus: () => {
    ...
    let f2 = c2.value;
    return p2 && (f2 = f2 + " " + p2), m2 && (f2 = f2 + " " + m2), l("div", { class: f2 }, [i3 || t2.prepend ? l("div", { class: "m-input-prepend" }, [i3 || t2.prepend]) : null, l("div", { class: "m-input-content" }, [e2 || t2.prefix ? l("div", { class: "m-input-prefix" }, [e2 || t2.prefix]) : null, l("input", { class: "m-input-inner", ref: o2, type: t2.type, disabled: t2.disabled, placeholder: t2.placeholder, readonly: t2.readonly, value: u2.value, autofocus: t2.autofocus, onInput: d2, onBlur: (e3) => {
...
function Y({ type: e2 }) {
  switch (e2) {
    case "success":
      return l(w, { size: "20px", name: "check-circle-fill" }, null);
    case "warning":
      return l(w, { size: "20px", name: "warning-circle-fill" }, null);
    case "danger":
      return l(w, { size: "20px", name: "close-circle-fill" }, null);
    default:
      return l(w, { size: "20px", name: "info-circle-fill" }, null);
  }
}
const W = n({ name: "MAlert", props: { type: { type: String, default: "primary" }, icon: { type: String, default: "" }, title: { type: String, default: "" }, description: { type: String, default: "" }, showClose: { type: Boolean, default: false }, showIcon: { type: Boolean, default: false }, dark: { type: Boolean, default: false } }, emits: ["close"], setup(t2, { slots: a2, emit: n2 }) {
  ...
  return () => {
    ...
    return l("div", { class: `m-alert m-alert-${t2.type} ${t2.dark ? "is-dark" : ""}`, style: { display: o2.value ? "block" : "none" } }, [l("main", { class: "m-alert-main" }, [t2.showIcon && s2 && l("div", { class: "m-alert-icon" }, [s2]), l("div", { class: "m-alert-content" }, [e2 && l("div", { class: "m-alert-title" }, [e2]), n3 && l("div", { class: "m-alert-description" }, [n3])]), t2.showClose && l("span", { class: "m-alert-close" }, [l(k, { onClick: i2, rightIcon: "close", type: "text", shape: "circle" }, null)])])]);
  };
...
} }), G = [k, x, S, B, C, _, z, I, R, $, q, D, w, W, X].map((e2) => (e2.install = function(t2) {
