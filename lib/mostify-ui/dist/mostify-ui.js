...
} }), J = l({ name: "MAvatar", components: { MIcon: w }, props: { src: { type: String, default: "" }, size: { type: String, default: "36px" }, alt: { type: String, default: "" }, srcSet: { type: String, default: "" }, fit: { type: String, default: "cover" }, icon: { type: String, default: "" }, shape: { type: String, default: "circle" }, loading: { type: String, default: "eager" } }, emits: ["error"], setup(e2, { slots: t2, emit: a2 }) {
  const l2 = (e3) => {
    a2("error", e3);
  };
  return () => {
    const a3 = t2.icon ? t2.icon() : e2.icon ? n(w, { name: e2.icon, class: "m-avatar-icon", size: String(0.6 * parseInt(e2.size)) + "px" }, null) : "", o2 = t2.default ? t2.default() : "";
