...
import { ref as e, inject as t, computed as a, defineComponent as l, createVNode as n, Fragment as o, provide as i, reactive as s, watch as r, onBeforeMount as u, onMounted as c, onUnmounted as d, Teleport as p, withDirectives as m, vShow as f, Transition as g, isVNode as y, mergeProps as h, createApp as v } from "vue";
...
} }), S = l({ name: "MDivider", props: { layout: { type: String, default: "y", validator: (e2) => ["x", "y"].includes(e2) }, color: { type: String, default: "" }, size: { type: String, default: "12px" }, borderStyle: { type: String, default: "solid" } }, setup: (e2) => () => n("div", { style: { "--color": e2.color, "--size": e2.size, "--border-style": e2.borderStyle }, class: { "m-divider": true, "m-divider-y": "y" === e2.layout, "m-divider-x": "x" === e2.layout } }, null) }), C = l({ name: "MAnchor", props: { getTarget: { type: Function, default: () => window } }, setup(e2, { slots: a2 }) {
  t(b);
  return () => n("div", null, [a2.default && a2.default()]);
} }), B = l({ name: "MConfigProvider", props: { locale: { type: String, default: "zh-CN" }, size: { type: String, default: "small", validator: (e2) => ["small", "mini", "large"].includes(e2) } }, setup: (e2, { slots: t2 }) => (i(b, e2), () => n(o, null, [t2.default && t2.default()])) }), z = l({ name: "MBreadcrumb", props: { separator: { type: String, default: "/" } }, setup(e2, { slots: t2 }) {
  var _a, _b;
...
}), M = { hideTime: 200, showTime: 200, bgShow: async (e2) => {
...
const T = l({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(t2, { slots: l2 }) {
  const o2 = e(null), i2 = e(null), g2 = e(null), y2 = e(false), h2 = s({ top: "0", left: "0", waitChange: false, renderToDom: null }), v2 = e(false);
  let b2 = null;
  const w2 = a(() => !t2.destroyOnHide || y2.value);
  let x2 = null;
  function k2() {
  ...
  return r(() => t2.trigger, () => {
    ...
    var _a;
    return [w2.value && m(n("div", { class: "m-dropdown__content m-box-shadow", ref: i2, style: { "--top": h2.top, "--left": h2.left, "pointer-events": h2.waitChange ? "none" : "all" } }, [n("div", { class: "m-dropdown__body", ref: g2 }, [l2.content && ((_a = l2.content()) == null ? void 0 : _a.map((e2) => (e2.props = { ...e2.props }, e2)))])]), [[f, y2.value]])];
  } })]);
} }), I = l({ name: "MButtonGroup", props: { layout: { type: String, default: "x", validator: (e2) => ["x", "y"].includes(e2) }, size: { type: String, default: "" } }, setup(e2, { slots: a2 }) {
  const l2 = t(b, { size: "" });
...
} }), H = l({ name: "MMenuItem", props: { disabled: Boolean, label: String }, emits: ["click"], setup(e2, { slots: t2, emit: a2 }) {
  function l2(t3) {
...
const A = l({ name: "MTransition", props: { onEnter: Function, onLeave: Function }, setup: (e2, t2) => () => {
  ...
  }, css: false }, "function" == typeof (l2 = a2) || "[object Object]" === Object.prototype.toString.call(l2) && !y(l2) ? a2 : { default: () => [a2] });
  var l2;
} }), R = async ({ mask: e2, content: t2, wrapper: a2 }) => {
  ...
  }), wrapperStyle: a(() => e2.fullscreen ? "width: 100%; height: 100%;" : "center" === e2.top ? "display: flex; \n        align-items: center; \n        justify-content: center; \n        min-height: 100%;\n      " : `position:relative;top: ${e2.top};padding-bottom:24px;`), bodyStyle: a(() => "width: 100%; height: 100%;  position: relative;insert: 0; overflow-y: auto;") }))(t2), g2 = (e2) => {
    var _a;
  ...
  return () => {
    ...
    return n(p, { to: t2.target }, { default: () => [n(A, { onEnter: v2, onLeave: b2 }, { default: () => [m(n("div", { class: `m-dialog ${t2.className || ""}`, "data-show": t2.visible, ref: r2, style: { "--m-dialog-mask-color": t2.maskBackgroundColor } }, [n("section", { class: "m-dialog-mask", ref: s2 }, null), n("div", { class: "m-dialog-container", onClick: () => t2.maskHide && g2("cancel") }, [n("div", { style: c2.value }, [n("div", { class: "m-dialog-cover", style: u2.value }, [n("div", { class: "m-dialog-content", onClick: (e3) => e3.stopPropagation() }, [n("div", { class: "m-dialog-content__background", ref: o2 }, null), n("section", { class: "m-dialog-content__wrapper", ref: i2, style: d2.value }, [t2.showClose && n(x, { type: "text", shape: "square", size: "small", class: "m-dialog-content__close", onClick: () => g2("cancel") }, { default: () => [n("svg", { fill: "currentColor", class: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "5090", width: "28", height: "28" }, [n("path", { d: "M504.224 470.288l207.84-207.84a16 16 0 0 1 22.608 0l11.328 11.328a16 16 0 0 1 0 22.624l-207.84 207.824 207.84 207.84a16 16 0 0 1 0 22.608l-11.328 11.328a16 16 0 0 1-22.624 0l-207.824-207.84-207.84 207.84a16 16 0 0 1-22.608 0l-11.328-11.328a16 16 0 0 1 0-22.624l207.84-207.824-207.84-207.84a16 16 0 0 1 0-22.608l11.328-11.328a16 16 0 0 1 22.624 0l207.824 207.84z" }, null)])] }), y3 || t2.title && n("header", { class: "m-dialog__header" }, [n("span", { class: "m-dialog-title" }, [t2.title])]), w2 || n("main", { class: "m-dialog__body" }, [e2 || t2.content]), a2 || (t2.cancelBtnText || t2.okBtnText) && n("footer", { class: "m-dialog__footer" }, [t2.cancelBtnText && n(x, h(t2.cancelBtnProps, { onClick: () => g2("cancel") }), { default: () => [t2.cancelBtnText] }), t2.okBtnText && n(x, h(t2.okBtnProps, { onClick: () => g2("ok") }), { default: () => [t2.okBtnText] })])])])])])])]), [[f, t2.visible]])] })] });
  };
} }), q = (e2) => {
  ...
  const o2 = v(F, { ...q(e2), target: t2, _onClose: async (i3) => {
    var _a, _b;
...
const G = l({ name: "MCheckbox", props: { size: { type: String, default: "small", validator: (e2) => ["mini", "small", "large"].includes(e2) }, label: { type: String, default: "" }, checked: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, indeterminate: { type: Boolean, default: false }, value: { type: [String, Number], default: "" }, modelValue: { type: [String, Number, Boolean, Array], default: false } }, emits: ["update:modelValue", "change", "update:indeterminate"], setup(t2, { emit: a2, slots: l2 }) {
  ...
  return () => {
    ...
    return n("div", { class: { "m-checkbox": true, "m-checkbox-disabled": t2.disabled, "m-checkbox-checked": o2.value, "m-checkbox-indeterminate": i2.value, "m-checkbox-size-mini": "mini" === t2.size, "m-checkbox-size-small": "small" === t2.size, "m-checkbox-size-large": "large" === t2.size }, "data-disabled": t2.disabled, "data-checked": o2.value, "data-indeterminate": i2.value, "data-value": t2.value, onClick: s2 }, [n("div", { class: "m-checkbox-wrapper" }, [n("span", { class: "m-checkbox-control-wrapper" }, [n("div", { class: "m-checkbox-control-main" }, [n("div", { class: "m-checkbox-control-inner" }, [Z({ checked: o2.value, indeterminate: i2.value })])])]), n("span", { class: "m-checkbox-label" }, [e2]), n("input", { type: "checkbox", class: "m-checkbox-input", checked: o2.value, disabled: t2.disabled, value: t2.value }, null)])]);
  };
} }), J = l({ name: "MAvatar", components: { MIcon: w }, props: { src: { type: String, default: "" }, size: { type: String, default: "36px" }, alt: { type: String, default: "" }, srcSet: { type: String, default: "" }, fit: { type: String, default: "cover" }, icon: { type: String, default: "" }, shape: { type: String, default: "circle" }, loading: { type: String, default: "eager" } }, setup(e2, { slots: t2 }) {
  const a2 = (e3) => {
  };
  return () => {
    const l2 = t2.icon ? t2.icon() : e2.icon ? n(w, { name: e2.icon, class: "m-avatar-icon", size: String(0.6 * parseInt(e2.size)) + "px" }, null) : "", o2 = t2.default ? t2.default() : "";
    return n("div", { class: { "m-avatar": true, "m-avatar-shape-square": "square" === e2.shape, "m-avatar-shape-circle": "circle" === e2.shape }, style: { "--size": e2.size, "--shape": e2.shape } }, [l2 || (o2 || n("img", { src: e2.src, alt: e2.alt, srcset: e2.srcSet, class: "m-avatar-image", style: { "object-fit": e2.fit || "none" }, loading: e2.loading, width: e2.size, height: e2.size, onError: a2 }, null))]);
  };
} }), K = [x, k, S, C, B, z, _, T, I, H, F, D, w, W, G, J].map((e2) => (e2.install = function(t2) {
