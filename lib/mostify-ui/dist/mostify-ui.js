...
import { ref as e, inject as t, computed as a, defineComponent as n, createVNode as l, Fragment as o, provide as i, reactive as s, watch as r, onBeforeMount as u, onMounted as c, onUnmounted as d, Teleport as p, withDirectives as m, vShow as f, Transition as y, isVNode as g, mergeProps as h, createApp as v } from "vue";
const w = Symbol("muiConfigProvider"), b = n({ name: "MIcon", props: { name: { type: String, default: "" }, size: { type: String, default: "16px" }, color: { type: String, default: "currentColor" } }, setup(e2, { emit: t2 }) {
  const n2 = a(() => `mostifyiconfont m-icon-${e2.name}`);
  return () => l("i", { class: n2.value, onClick: (e3) => t2("click", e3), style: { color: e2.color, fontSize: e2.size ? e2.size : "16px", lineHeight: "inherit" } }, null);
} }), x = n({ name: "MButton", props: { type: { type: String, default: "default" }, size: String, shape: String, disabled: Boolean, loading: Boolean, border: Boolean, light: Boolean, leftIcon: String, rightIcon: String }, emits: ["click", "focus", "blur"], setup(n2, { slots: i2, emit: s2 }) {
  const { btnClass: r2, contentShow: u2, setClickXEvent: c2, btnRef: d2, rippleRef: p2 } = ((n3) => {
    const l2 = e(null), o2 = e(null), i3 = t(w, { size: "" }), s3 = a(() => {
      const e2 = ["m-button"];
  ...
  return () => {
    const e2 = i2.leftIcon ? i2.leftIcon() : n2.leftIcon ? l(b, { name: n2.leftIcon }, null) : "", t2 = i2.rightIcon ? i2.rightIcon() : n2.rightIcon ? l(b, { name: n2.rightIcon }, null) : "";
    return l("button", { class: r2.value, onMousedown: f2, ref: d2, style: { "--border-width": n2.border ? "1px" : "0px" }, "data-light": n2.light ? "on" : "off", onClick: (e3) => m2(e3, "click"), onFocus: (e3) => m2(e3, "focus"), onBlur: (e3) => m2(e3, "blur") }, [!n2.loading && !n2.disabled && l("div", { class: "m-button-ripple-wrapper", ref: p2 }, null), l("span", { class: "m-button-main" }, [n2.loading && l("span", { class: "m-button-loading-icon-wrapper", style: { marginRight: u2.value ? "8px" : 0 } }, [l("svg", { viewBox: "0 0 1024 1024", width: "1em", height: "1em", class: "m-button-icon-loading" }, [l("path", { d: "M980.752 313.697c-25.789-60.972-62.702-115.725-109.713-162.736-47.012-47.011-101.764-83.924-162.736-109.713C645.161 14.542 578.106 1 509 1c-2.242 0-4.48 0.015-6.715 0.043-16.567 0.211-29.826 13.812-29.615 30.38 0.209 16.438 13.599 29.618 29.99 29.618l0.39-0.002c1.98-0.026 3.963-0.039 5.95-0.039 61.033 0 120.224 11.947 175.93 35.508 53.82 22.764 102.162 55.359 143.683 96.879s74.115 89.862 96.88 143.683C949.054 392.776 961 451.967 961 513c0 16.568 13.432 30 30 30s30-13.432 30-30c0-69.106-13.541-136.162-40.248-199.303z", fill: "currentColor" }, null)])]), u2.value && l(o, null, [e2 && l("span", { class: "m-button-icon-left" }, [e2]), i2.default && i2.default(), t2 && l("span", { class: "m-button-icon-right" }, [t2])])])]);
  };
} }), k = n({ name: "MSpace", props: { size: { type: String, default: "" }, layout: { type: String, validator: (e2) => ["x", "y"].includes(e2), default: "x" }, alignItems: { type: String, default: "flex-start" } }, setup(e2, { slots: t2 }) {
  const n2 = a(() => "y" === e2.layout ? "m-space-y" : "m-space-x"), o2 = a(() => t2.default ? t2.default() : []);
  return () => {
    var _a;
    return l("div", { class: ["m-space", n2.value], style: { "--size": e2.size || "", "align-items": e2.alignItems || "" } }, [(_a = o2.value) == null ? void 0 : _a.map((e3, t3) => l("div", { class: "m-space-item", key: t3 }, [e3]))]);
  };
} }), S = n({ name: "MDivider", props: { layout: { type: String, default: "x", validator: (e2) => ["x", "y"].includes(e2) }, color: { type: String, default: "" }, size: { type: String, default: "12px" } }, setup(e2) {
...
} }), C = n({ name: "MAnchor", props: { getTarget: { type: Function, default: () => window } }, setup(e2, { slots: a2 }) {
  t(w);
  return () => l("div", null, [a2.default && a2.default()]);
} }), B = n({ name: "MConfigProvider", props: { locale: { type: String, default: "zh-CN" }, size: { type: String, default: "small", validator: (e2) => ["small", "mini", "large"].includes(e2) } }, setup: (e2, { slots: t2 }) => (i(w, e2), () => l(o, null, [t2.default && t2.default()])) }), _ = n({ name: "MBreadcrumb", props: { separator: { type: String, default: "/" }, color: String, activeColor: String }, setup(e2, { slots: t2 }) {
  const n2 = a(() => {
    var _a, _b;
  ...
  return () => {
    var _a, _b;
    return l("div", { class: "m-breadcrumb", style: { "--color": e2.color, "--activeColor": e2.activeColor } }, [(_b = (_a = t2 == null ? void 0 : t2.default) == null ? void 0 : _a.call(t2)) == null ? void 0 : _b.map((a2, i2) => {
      var _a2;
      return l(o, null, [a2, i2 >= 0 && i2 < n2.value - 1 && l("span", null, [t2.separator && ((_a2 = t2.separator) == null ? void 0 : _a2.call(t2)) || e2.separator])]);
    })]);
  };
} }), z = n({ name: "MBreadcrumbItem", props: { title: { type: String, default: "" }, disabled: Boolean }, emits: ["click"], setup(e2, { emit: t2, slots: a2 }) {
  function n2(a3) {
    a3.preventDefault(), (e2 == null ? void 0 : e2.disabled) || t2("click", a3);
  }
  return () => l("div", { class: ["m-breadcrumb__item", e2.disabled ? "is__disabled" : ""], "data-disabled": e2.disabled, onClick: n2 }, [a2.default && a2.default() || e2.title]);
...
}), E = (e2, t2, a2, n2 = 0) => new Promise(async (l2, o2) => {
...
const M = n({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(t2, { slots: n2 }) {
  ...
  let w2 = null;
  const b2 = a(() => !t2.destroyOnHide || g2.value);
  let x2 = null;
  function k2() {
  ...
  return r(() => t2.trigger, () => {
    ...
    $2();
  }), () => l("div", null, [l("div", { class: "m-dropdown", ref: o2, style: { "pointer-events": h2.waitChange ? "none" : "all" } }, [n2.default && n2.default()]), l(p, { to: "#m-inset__body" }, { default: () => {
    var _a;
    return [b2.value && m(l("div", { class: "m-dropdown__content m-box-shadow", ref: i2, style: { "--top": h2.top, "--left": h2.left, "pointer-events": h2.waitChange ? "none" : "all" } }, [l("div", { class: "m-dropdown__body", ref: y2 }, [n2.content && ((_a = n2.content()) == null ? void 0 : _a.map((e2) => (e2.props = { ...e2.props }, e2)))])]), [[f, g2.value]])];
  } })]);
  ...
  const n2 = t(w, { size: "" });
  return i(w, { size: e2.size || n2.size }), () => l("div", { class: ["m-button-group", "y" === e2.layout ? "m-button-layout-y" : "m-button-layout-x"] }, [a2.default && a2.default()]);
  ...
  return () => l("div", { class: ["m-menu__item", e2.disabled ? "is__disabled" : ""], "data-disabled": e2.disabled, "aria-disabled": e2.disabled, onClick: n2 }, [t2.default && t2.default() || e2.label]);
} });
const N = n({ name: "MTransition", props: { onEnter: Function, onLeave: Function }, setup: (e2, t2) => () => {
  ...
  }, css: false }, "function" == typeof (n2 = a2) || "[object Object]" === Object.prototype.toString.call(n2) && !g(n2) ? a2 : { default: () => [a2] });
  var n2;
  ...
  return () => {
    ...
    return l(p, { to: t2.target }, { default: () => [l(N, { onEnter: v2, onLeave: w2 }, { default: () => [m(l("div", { class: `m-dialog ${t2.className || ""}`, "data-show": t2.visible, ref: r2, style: { "--m-dialog-mask-color": t2.maskBackgroundColor } }, [l("section", { class: "m-dialog-mask", ref: s2 }, null), l("div", { class: "m-dialog-container", onClick: () => t2.maskHide && y2("cancel") }, [l("div", { style: c2.value }, [l("div", { class: "m-dialog-cover", style: u2.value }, [l("div", { class: "m-dialog-content", onClick: (e3) => e3.stopPropagation() }, [l("div", { class: "m-dialog-content__background", ref: o2 }, null), l("section", { class: "m-dialog-content__wrapper", ref: i2, style: d2.value }, [t2.showClose && l(x, { type: "text", shape: "square", size: "small", class: "m-dialog-content__close", onClick: () => y2("cancel") }, { default: () => [l("svg", { fill: "currentColor", class: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "5090", width: "28", height: "28" }, [l("path", { d: "M504.224 470.288l207.84-207.84a16 16 0 0 1 22.608 0l11.328 11.328a16 16 0 0 1 0 22.624l-207.84 207.824 207.84 207.84a16 16 0 0 1 0 22.608l-11.328 11.328a16 16 0 0 1-22.624 0l-207.824-207.84-207.84 207.84a16 16 0 0 1-22.608 0l-11.328-11.328a16 16 0 0 1 0-22.624l207.84-207.824-207.84-207.84a16 16 0 0 1 0-22.608l11.328-11.328a16 16 0 0 1 22.624 0l207.824 207.84z" }, null)])] }), g3 || t2.title && l("header", { class: "m-dialog__header" }, [l("span", { class: "m-dialog-title" }, [t2.title])]), b2 || l("main", { class: "m-dialog__body" }, [e2 || t2.content]), a2 || (t2.cancelBtnText || t2.okBtnText) && l("footer", { class: "m-dialog__footer" }, [t2.cancelBtnText && l(x, h(t2.cancelBtnProps, { onClick: () => y2("cancel") }), { default: () => [t2.cancelBtnText] }), t2.okBtnText && l(x, h(t2.okBtnProps, { onClick: () => y2("ok") }), { default: () => [t2.okBtnText] })])])])])])])]), [[f, t2.visible]])] })] });
  };
} }), V = (e2) => {
  ...
  return i2({ focus: () => {
    ...
    const e2 = ((_a = o2 == null ? void 0 : o2.prefix) == null ? void 0 : _a.call(o2)) || t2.prefix, a2 = ((_b = o2 == null ? void 0 : o2.suffix) == null ? void 0 : _b.call(o2)) || t2.suffix, n3 = ((_c = o2 == null ? void 0 : o2.prepend) == null ? void 0 : _c.call(o2)) || t2.prepend, i3 = ((_d = o2 == null ? void 0 : o2.append) == null ? void 0 : _d.call(o2)) || t2.append, r2 = () => {
      var _a2;
      return l("div", { onClick: () => d2(true), style: { width: t2.width }, class: { "m-input": true, "is-disabled": t2.disabled, "is-readonly": t2.readonly, "is-focus": c2.value, "m-input-size-large": "large" === t2.size, "m-input-size-small": "small" === t2.size, "m-input-size-mini": "mini" === t2.size } }, [e2 && l("div", { class: "m-input-prefix" }, [e2]), l("input", { class: "m-input-base", ref: s2, type: g2.value || t2.type, disabled: t2.disabled, placeholder: t2.placeholder, readonly: t2.readonly, value: u2.value, autofocus: t2.autofocus, autocomplete: t2.autocomplete, maxlength: t2.maxlength, max: t2.max, min: t2.min, step: t2.step, minlength: t2.minlength, name: t2.name, onInput: p2, onBlur: () => d2(false), onFocus: () => d2(true) }, null), t2.clearable && u2.value && l("span", { class: "m-input-suffix-icon-wrapper m-clearable", onClick: m2 }, [l(b, { name: "close-circle" }, null)]), f2.value && l("span", { onClick: h2, class: "m-input-suffix-icon-wrapper" }, [l(b, { name: y2.value ? "eye" : "eye-close" }, null)]), v2.value && l("span", { class: "m-input-limit-count" }, [`${(_a2 = u2.value) == null ? void 0 : _a2.length}/${t2.maxlength}`]), a2 && l("div", { class: "m-input-suffix" }, [a2])]);
    };
    return n3 || i3 ? l("div", { class: { "m-input-wrapper": true, "has-prepend": n3, "has-append": i3 } }, [n3 && l("div", { class: "m-input-prepend" }, [n3]), r2(), i3 && l("div", { class: "m-input-append" }, [i3])]) : r2();
  };
} });
function Y({ type: e2 }) {
  switch (e2) {
    case "success":
      return l(b, { size: "20px", name: "check-circle-fill" }, null);
    case "warning":
      return l(b, { size: "20px", name: "warning-circle-fill" }, null);
    case "danger":
      return l(b, { size: "20px", name: "close-circle-fill" }, null);
    default:
      return l(b, { size: "20px", name: "info-circle-fill" }, null);
  }
}
const W = n({ name: "MAlert", props: { type: { type: String, default: "primary" }, icon: { type: String, default: "" }, title: { type: String, default: "" }, description: { type: String, default: "" }, showClose: { type: Boolean, default: false }, showIcon: { type: Boolean, default: false }, dark: { type: Boolean, default: false } }, emits: ["close"], setup(t2, { slots: a2, emit: n2 }) {
  const o2 = e(true), i2 = () => {
    o2.value = false, n2("close");
  };
  return () => {
    const e2 = a2.title ? a2.title() : t2.title, n3 = a2.default ? a2.default() : t2.description, s2 = a2.icon ? a2.icon() : t2.icon ? l(Y, { type: t2.type }, null) : "";
    return l("div", { class: `m-alert m-alert-${t2.type} ${t2.dark ? "is-dark" : ""}`, style: { display: o2.value ? "block" : "none" } }, [l("main", { class: "m-alert-main" }, [t2.showIcon && s2 && l("div", { class: "m-alert-icon" }, [s2]), l("div", { class: "m-alert-content" }, [e2 && l("div", { class: "m-alert-title" }, [e2]), n3 && l("div", { class: "m-alert-description" }, [n3])]), t2.showClose && l("span", { class: "m-alert-close" }, [l(x, { onClick: i2, rightIcon: "close", type: "text", shape: "circle" }, null)])])]);
  };
} }), X = n({ name: "MCheckbox", props: { label: { type: String, default: "" }, checked: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, indeterminate: { type: Boolean, default: false }, value: { type: [String, Number], default: "" } }, emits: ["update:modelValue", "change", "update:checked", "update:indeterminate"], setup(t2, { emit: a2, slots: n2 }) {
  const { checked: o2, indeterminate: i2, toggle: s2 } = ((t3, a3) => {
    const n3 = e(t3.indeterminate), l2 = e(t3.checked);
    return { toggle: () => {
  ...
  return () => {
    ...
    return l("div", { class: { "m-checkbox": true, "m-checkbox-indeterminate": i2 }, onClick: s2 }, [l("div", { class: "m-checkbox-main" }, [l("span", { class: "m-checkbox-state" }, [l("input", { type: "checkbox", class: "m-checkbox-input", checked: o2.value, disabled: t2.disabled, value: t2.value }, null), l("span", { class: "m-checkbox-box" }, null)]), l("span", { class: "m-checkbox-label" }, [e2])])]);
  };
} }), G = [x, k, S, C, B, _, z, M, R, $, q, D, b, W, X].map((e2) => (e2.install = function(t2) {
