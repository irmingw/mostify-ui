...
import { ref as e, inject as t, computed as a, defineComponent as o, createVNode as n, provide as l, Fragment as i, reactive as s, watch as r, onBeforeMount as u, onMounted as d, onUnmounted as c, Teleport as p, withDirectives as f, vShow as m, Transition as y, isVNode as g, mergeProps as v, createApp as h } from "vue";
...
} }), S = o({ name: "MDivider", props: { layout: { type: String, default: "x", validator: (e2) => ["x", "y"].includes(e2) }, color: { type: String, default: "" }, size: { type: String, default: "12px" } }, setup(e2) {
...
} }), x = o({ name: "MLayout", props: { layout: { type: String, default: "y" } }, setup(e2, { slots: t2 }) {
...
const N = o({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(t2, { slots: o2 }) {
  const l2 = e(null), i2 = e(null), y2 = e(null), g2 = e(false), v2 = s({ top: "0", left: "0", waitChange: false, renderToDom: null }), h2 = e(false);
  let b2 = null;
  ...
  return r(() => t2.trigger, () => {
    ...
    T2();
  }), () => n("div", null, [n("div", { class: "m-dropdown", ref: l2, style: { "pointer-events": v2.waitChange ? "none" : "all" } }, [o2.default && o2.default()]), n(p, { to: "#m-inset__body" }, { default: () => {
    var _a;
    return [w2.value && f(n("div", { class: "m-dropdown__content m-box-shadow", ref: i2, style: { "--top": v2.top, "--left": v2.left, "pointer-events": v2.waitChange ? "none" : "all" } }, [n("div", { class: "m-dropdown__body", ref: y2 }, [o2.content && ((_a = o2.content()) == null ? void 0 : _a.map((e2) => (e2.props = { ...e2.props }, e2)))])]), [[m, g2.value]])];
  } })]);
...
const j = o({ name: "MTransition", props: { onEnter: Function, onLeave: Function }, setup: (e2, t2) => () => {
  ...
  }, css: false }, "function" == typeof (o2 = a2) || "[object Object]" === Object.prototype.toString.call(o2) && !g(o2) ? a2 : { default: () => [a2] });
  var o2;
  ...
  return () => {
    ...
    return n(p, { to: t2.target }, { default: () => [n(j, { onEnter: h2, onLeave: b2 }, { default: () => [f(n("div", { class: `m-dialog ${t2.className || ""}`, "data-show": t2.visible, ref: r2, style: { "--m-dialog-background_color": t2.backgroundColor, "--m-dialog__bask_color": t2.maskBackgroundColor } }, [n("section", { class: "m-dialog-mask", ref: s2 }, null), n("div", { class: "m-dialog-container", onClick: () => t2.maskHide && y2("cancel") }, [n("div", { style: d2.value }, [n("div", { class: "m-dialog-cover", style: u2.value }, [n("div", { class: "m-dialog-content", onClick: (e3) => e3.stopPropagation() }, [n("div", { class: "m-dialog-content__background", ref: l2 }, null), n("section", { class: "m-dialog-content__wrapper", ref: i2, style: c2.value }, [t2.showClose && n(w, { type: "text", shape: "square", size: "small", class: "m-dialog-content__close", onClick: () => y2("cancel") }, { default: () => [n("svg", { fill: "currentColor", class: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "5090", width: "28", height: "28" }, [n("path", { d: "M504.224 470.288l207.84-207.84a16 16 0 0 1 22.608 0l11.328 11.328a16 16 0 0 1 0 22.624l-207.84 207.824 207.84 207.84a16 16 0 0 1 0 22.608l-11.328 11.328a16 16 0 0 1-22.624 0l-207.824-207.84-207.84 207.84a16 16 0 0 1-22.608 0l-11.328-11.328a16 16 0 0 1 0-22.624l207.84-207.824-207.84-207.84a16 16 0 0 1 0-22.608l11.328-11.328a16 16 0 0 1 22.624 0l207.824 207.84z" }, null)])] }), g3 || t2.title && n("header", { class: "m-dialog__header" }, [n("span", { class: "m-dialog-title" }, [t2.title])]), k2 || n("main", { class: "m-dialog__body" }, [e2 || t2.content]), a2 || (t2.cancelBtnText || t2.okBtnText) && n("footer", { class: "m-dialog__footer" }, [t2.cancelBtnText && n(w, v(t2.cancelBtnProps, { onClick: () => y2("cancel") }), { default: () => [t2.cancelBtnText] }), t2.okBtnText && n(w, v(t2.okBtnProps, { onClick: () => y2("ok") }), { default: () => [t2.okBtnText] })])])])])])])]), [[m, t2.visible]])] })] });
  };
} }), Y = (e2) => {
...
} }), K = o({ name: "MIcon", props: { name: { type: String, default: "" }, size: { type: String, default: "16px" }, color: { type: String, default: "currentColor" } }, setup(e2) {
  const t2 = a(() => `mostifyiconfont m-icon-${e2.name}`);
  return () => n("i", { class: t2.value, style: { color: e2.color, fontSize: e2.size, lineHeight: "inherit" } }, null);
} }), Q = [w, k, S, x, C, B, _, L, E, M, z, T, N, q, A, I, G, J, K].map((e2) => (e2.install = function(t2) {
