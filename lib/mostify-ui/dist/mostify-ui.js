...
import { ref as e, inject as t, computed as a, defineComponent as o, createVNode as n, provide as l, Fragment as i, reactive as s, watch as r, onBeforeMount as u, onMounted as d, onUnmounted as c, Teleport as p, withDirectives as f, vShow as m, Transition as y, isVNode as v, mergeProps as g, createApp as h } from "vue";
const b = Symbol("muiConfigProvider"), w = o({ name: "MButton", props: { type: String, size: String, shape: String, disabled: Boolean, loading: Boolean, border: Boolean, light: Boolean }, emits: ["click", "focus", "blur"], setup(o2, { slots: l2, emit: i2 }) {
  const { btnClass: s2, contentShow: r2, setClickXEvent: u2, btnRef: d2, rippleRef: c2 } = ((o3) => {
    const n2 = e(null), l3 = e(null), i3 = t(b, { size: "" }), s3 = a(() => {
      const e2 = ["m-button"];
    ...
    }), r3 = a(() => !(o3.loading && ["circle", "square"].includes(o3.shape))), u3 = document.createElement("div");
    return u3.className = "m-button-ripple", { btnClass: s3, contentShow: r3, setClickXEvent: async (e2) => {
      if (!n2.value) return;
  ...
  return () => n("button", { class: s2.value, onMousedown: f2, ref: d2, style: { "--border-width": o2.border ? "1px" : "0px" }, "data-light": o2.light ? "on" : "off", onClick: (e2) => p2(e2, "click"), onFocus: (e2) => p2(e2, "focus"), onBlur: (e2) => p2(e2, "blur") }, [!o2.loading && !o2.disabled && n("div", { class: "m-button-ripple-wrapper", ref: c2 }, null), n("span", { class: "m-button-main" }, [o2.loading && n("span", { class: "m-button-loading-icon-wrapper", style: { marginRight: r2.value ? "8px" : 0 } }, [n("svg", { viewBox: "0 0 1024 1024", width: "1em", height: "1em", class: "m-button-icon-loading" }, [n("path", { d: "M980.752 313.697c-25.789-60.972-62.702-115.725-109.713-162.736-47.012-47.011-101.764-83.924-162.736-109.713C645.161 14.542 578.106 1 509 1c-2.242 0-4.48 0.015-6.715 0.043-16.567 0.211-29.826 13.812-29.615 30.38 0.209 16.438 13.599 29.618 29.99 29.618l0.39-0.002c1.98-0.026 3.963-0.039 5.95-0.039 61.033 0 120.224 11.947 175.93 35.508 53.82 22.764 102.162 55.359 143.683 96.879s74.115 89.862 96.88 143.683C949.054 392.776 961 451.967 961 513c0 16.568 13.432 30 30 30s30-13.432 30-30c0-69.106-13.541-136.162-40.248-199.303z", fill: "currentColor" }, null)])]), r2.value ? l2.default && l2.default() : null])]);
  ...
  return () => {
    ...
    return n("div", { class: "m-breadcrumb", style: { "--color": e2.color, "--activeColor": e2.activeColor } }, [(_b = (_a = t2 == null ? void 0 : t2.default) == null ? void 0 : _a.call(t2)) == null ? void 0 : _b.map((a2, l2) => {
      var _a2;
      return n(i, null, [a2, l2 >= 0 && l2 < o2.value - 1 && n("span", null, [t2.separator && ((_a2 = t2.separator) == null ? void 0 : _a2.call(t2)) || e2.separator])]);
    })]);
  };
...
}), H = (e2, t2, a2, o2 = 0) => new Promise(async (n2, l2) => {
...
const N = o({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(t2, { slots: o2 }) {
  ...
  function x2() {
    ...
    g2.top = `${o3}px`, g2.left = `${n2}px`, i2.value.style.minWidth = `${e2.width}px`;
  }
  function S2() {
    w2.value && x2();
  }
  ...
  return r(() => t2.trigger, () => {
    ...
    T2();
  }), () => n("div", null, [n("div", { class: "m-dropdown", ref: l2, style: { "pointer-events": g2.waitChange ? "none" : "all" } }, [o2.default && o2.default()]), n(p, { to: "#m-inset__body" }, { default: () => {
    var _a;
    return [w2.value && f(n("div", { class: "m-dropdown__content m-box-shadow", ref: i2, style: { "--top": g2.top, "--left": g2.left, "pointer-events": g2.waitChange ? "none" : "all" } }, [n("div", { class: "m-dropdown__body", ref: y2 }, [o2.content && ((_a = o2.content()) == null ? void 0 : _a.map((e2) => (e2.props = { ...e2.props }, e2)))])]), [[m, v2.value]])];
  } })]);
...
const j = o({ name: "MTransition", props: { onEnter: Function, onLeave: Function }, setup: (e2, t2) => () => {
  ...
  const { wrapperRef: l2, bodyRef: i2, maskRef: s2, dialogRef: r2 } = { dialogRef: e(null), wrapperRef: e(null), maskRef: e(null), bodyRef: e(null) }, { contentStyle: u2, wrapperStyle: d2, bodyStyle: c2 } = ((e2) => ({ contentStyle: a(() => {
    ...
    const o3 = "center";
    l2.value.style.setProperty("transform-origin", o3), i2.value.style.setProperty("transform-origin", o3), V('.m-dialog[data-show="true"]'), await O({ mask: s2.value, content: i2.value, wrapper: l2.value }), t2.escHide && document.addEventListener("keyup", v2), a2();
  }, b2 = async (e2, t3) => {
    await D({ mask: s2.value, content: i2.value, wrapper: l2.value }), V('.m-dialog[data-show="true"]'), document.removeEventListener("keyup", v2), t3();
  };
  return () => {
    ...
    return n(p, { to: t2.target }, { default: () => [n(j, { onEnter: h2, onLeave: b2 }, { default: () => [f(n("div", { class: `m-dialog ${t2.className || ""}`, "data-show": t2.visible, ref: r2, style: { "--m-dialog-background_color": t2.backgroundColor, "--m-dialog__bask_color": t2.maskBackgroundColor } }, [n("section", { class: "m-dialog-mask", ref: s2 }, null), n("div", { class: "m-dialog-container", onClick: () => t2.maskHide && y2("cancel") }, [n("div", { style: d2.value }, [n("div", { class: "m-dialog-cover", style: u2.value }, [n("div", { class: "m-dialog-content", onClick: (e3) => e3.stopPropagation() }, [n("div", { class: "m-dialog-content__background", ref: l2 }, null), n("section", { class: "m-dialog-content__wrapper", ref: i2, style: c2.value }, [t2.showClose && n(w, { type: "text", shape: "square", size: "small", class: "m-dialog-content__close", onClick: () => y2("cancel") }, { default: () => [n("svg", { fill: "currentColor", class: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "5090", width: "28", height: "28" }, [n("path", { d: "M504.224 470.288l207.84-207.84a16 16 0 0 1 22.608 0l11.328 11.328a16 16 0 0 1 0 22.624l-207.84 207.824 207.84 207.84a16 16 0 0 1 0 22.608l-11.328 11.328a16 16 0 0 1-22.624 0l-207.824-207.84-207.84 207.84a16 16 0 0 1-22.608 0l-11.328-11.328a16 16 0 0 1 0-22.624l207.84-207.824-207.84-207.84a16 16 0 0 1 0-22.608l11.328-11.328a16 16 0 0 1 22.624 0l207.824 207.84z" }, null)])] }), v3 || t2.title && n("header", { class: "m-dialog__header" }, [n("span", { class: "m-dialog-title" }, [t2.title])]), k2 || n("main", { class: "m-dialog__body" }, [e2 || t2.content]), a2 || (t2.cancelBtnText || t2.okBtnText) && n("footer", { class: "m-dialog__footer" }, [t2.cancelBtnText && n(w, g(t2.cancelBtnProps, { onClick: () => y2("cancel") }), { default: () => [t2.cancelBtnText] }), t2.okBtnText && n(w, g(t2.okBtnProps, { onClick: () => y2("ok") }), { default: () => [t2.okBtnText] })])])])])])])]), [[m, t2.visible]])] })] });
  };
} }), Y = (e2) => {
  ...
  const l2 = h(I, { ...Y(e2), target: t2, _onClose: async (i3) => {
    var _a, _b;
  ...
  return () => {
    ...
    return n(p, { to: "body" }, { default: () => [n(j, { onEnter: o2, onLeave: l2 }, { default: () => [f(n("div", { class: "m-mask", onClick: a2, style: { "--m-mask-background": e2.background } }, [n("div", { class: "m-mask-bg" }, null), n("div", { onClick: (e3) => e3.stopPropagation(), class: "m-mask-body" }, [i2])]), [[m, e2.visible]])] })] });
  };
  ...
  const { inputRef: l2, isFocus: i2, setIsFocus: s2, inputValue: u2 } = ((t3) => {
    const a2 = e(null), o3 = e(false), n2 = e(t3.value || t3.modelValue || "");
  ...
  return o2.expose({ focus: () => {
    ...
    let m2 = d2.value;
    return p2 && (m2 = m2 + " " + p2), f2 && (m2 = m2 + " " + f2), n("div", { class: m2 }, [i3 || t2.prepend ? n("div", { class: "m-input-prepend" }, [i3 || t2.prepend]) : null, n("div", { class: "m-input-content" }, [e2 || t2.prefix ? n("div", { class: "m-input-prefix" }, [e2 || t2.prefix]) : null, n("input", { class: "m-input-inner", ref: l2, type: t2.type, disabled: t2.disabled, placeholder: t2.placeholder, readonly: t2.readonly, value: u2.value, autofocus: t2.autofocus, onInput: c2, onBlur: (e3) => {
      s2(false), o2.emit("blur", e3);
    }, onFocus: (e3) => {
      s2(true), o2.emit("focus", e3);
    } }, null), t2.clearable && u2.value && n("span", { class: "m-input-clear", onClick: () => {
      u2.value = "", o2.emit("update:modelValue", u2.value), o2.emit("change", u2.value);
    } }, [n("svg", { class: "m-input-clear-icon", fill: "currentColor", viewBox: "0 0 1024 1024" }, [n("path", { d: "M554.586353 512l170.556235-170.556235c11.444706-11.414588 11.595294-30.659765-0.180706-42.405647a29.906824 29.906824 0 0 0-42.405647-0.180706L512 469.413647l-170.556235-170.556235a30.208 30.208 0 0 0-42.405647 0.180706 29.906824 29.906824 0 0 0-0.180706 42.405647L469.413647 512l-170.556235 170.556235c-11.444706 11.414588-11.595294 30.659765 0.180706 42.405647a29.906824 29.906824 0 0 0 42.405647 0.180706L512 554.586353l170.556235 170.556235c11.414588 11.444706 30.659765 11.595294 42.405647-0.180706a29.906824 29.906824 0 0 0 0.180706-42.405647L554.586353 512zM512 993.882353C245.850353 993.882353 30.117647 778.149647 30.117647 512S245.850353 30.117647 512 30.117647s481.882353 215.732706 481.882353 481.882353-215.732706 481.882353-481.882353 481.882353z" }, null)])]), a2 || t2.suffix && n("div", { class: "m-input-suffix" }, [a2 || t2.suffix])]), r2 || t2.append ? n("div", { class: "m-input-append" }, [r2 || t2.append]) : null]);
  };
