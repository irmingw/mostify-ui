...
export const isSameOrChildNode = (
  parent: HTMLElement,
  child: HTMLElement
): boolean => {
...
export const animate = (
  ...
  return new Promise(async (resolve) => {
    ...
    const time: number | string | CSSNumericValue =
      typeof options === "number" ? options : options?.duration || null;
