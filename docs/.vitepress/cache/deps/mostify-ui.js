...
var S = defineComponent({ name: "MIcon", props: { name: { type: String, default: "" }, size: { type: String, default: "16px" }, color: { type: String, default: "currentColor" } }, setup(e2, { emit: t2 }) {
...
var k = defineComponent({ name: "MButton", props: { type: { type: String, default: "default" }, size: String, shape: { type: String, default: "" }, disabled: Boolean, loading: Boolean, border: Boolean, light: Boolean, leftIcon: String, rightIcon: String, block: { type: Boolean, default: false } }, emits: ["click", "focus", "blur"], setup(e2, { slots: l2, emit: s2 }) {
  const { btnClass: i2, contentShow: r2, btnRef: u2 } = ((e3) => {
    const l3 = ref(null), { size: n2 } = x();
    ...
    }), contentShow: computed(() => !(e3.loading && ["circle", "square"].includes(e3.shape))), btnRef: l3 };
  ...
  return () => {
    const t2 = l2.leftIcon ? l2.leftIcon() : e2.leftIcon ? createVNode(S, { name: e2.leftIcon }, null) : "", a2 = l2.rightIcon ? l2.rightIcon() : e2.rightIcon ? createVNode(S, { name: e2.rightIcon }, null) : "";
    return createVNode("button", { class: i2.value, onMousedown: d2, ref: u2, style: { "--border-width": e2.border ? "1px" : "0px", width: e2.block ? "100%" : "" }, "data-light": e2.light ? "on" : "off", onClick: (e3) => p2(e3, "click"), onFocus: (e3) => p2(e3, "focus"), onBlur: (e3) => p2(e3, "blur") }, [!e2.loading && !e2.disabled && createVNode("div", { class: "m-button-ripple-wrapper", ref: c2 }, null), createVNode("span", { class: "m-button-main" }, [e2.loading && (s3 = r2.value, createVNode("span", { class: "m-button-loading-icon-wrapper", style: { marginRight: s3 ? "8px" : 0 } }, [createVNode("svg", { viewBox: "0 0 1024 1024", width: "1em", height: "1em", class: "m-button-icon-loading" }, [createVNode("path", { d: "M980.752 313.697c-25.789-60.972-62.702-115.725-109.713-162.736-47.012-47.011-101.764-83.924-162.736-109.713C645.161 14.542 578.106 1 509 1c-2.242 0-4.48 0.015-6.715 0.043-16.567 0.211-29.826 13.812-29.615 30.38 0.209 16.438 13.599 29.618 29.99 29.618l0.39-0.002c1.98-0.026 3.963-0.039 5.95-0.039 61.033 0 120.224 11.947 175.93 35.508 53.82 22.764 102.162 55.359 143.683 96.879s74.115 89.862 96.88 143.683C949.054 392.776 961 451.967 961 513c0 16.568 13.432 30 30 30s30-13.432 30-30c0-69.106-13.541-136.162-40.248-199.303z", fill: "currentColor" }, null)])])), r2.value && createVNode(Fragment, null, [t2 && createVNode("span", { class: "m-button-icon-left" }, [t2]), l2.default && l2.default(), a2 && createVNode("span", { class: "m-button-icon-right" }, [a2])])])]);
    var s3;
  };
} });
var B = defineComponent({ name: "MSpace", props: { size: { type: String, default: "" }, layout: { type: String, validator: (e2) => ["x", "y"].includes(e2), default: "x" }, alignItems: { type: String, default: "flex-start" } }, setup(e2, { slots: t2 }) {
...
var C = defineComponent({ name: "MDivider", props: { layout: { type: String, default: "y", validator: (e2) => ["x", "y"].includes(e2) }, color: { type: String, default: "" }, size: { type: String, default: "12px" }, borderStyle: { type: String, default: "solid" } }, setup: (e2) => () => createVNode("div", { style: { "--color": e2.color, "--size": e2.size, "--border-style": e2.borderStyle }, class: { "m-divider": true, "m-divider-y": "y" === e2.layout, "m-divider-x": "x" === e2.layout } }, null) });
var z = defineComponent({ name: "MAnchor", props: { getTarget: { type: Function, default: () => window } }, setup(t2, { slots: a2 }) {
  inject(w);
  return () => createVNode("div", null, [a2.default && a2.default()]);
} });
var I = defineComponent({ name: "MConfigProvider", props: { locale: { type: String, default: "zh-CN" }, size: { type: String, default: "small", validator: (e2) => ["small", "mini", "large"].includes(e2) } }, setup: (e2, { slots: t2 }) => () => createVNode(Fragment, null, [t2.default && t2.default()]) });
var M = defineComponent({ name: "MBreadcrumb", props: { separator: { type: String, default: "/" } }, setup(e2, { slots: t2 }) {
  var _a, _b;
...
var L = defineComponent({ name: "MBreadcrumbItem", props: { label: { type: String, default: "" }, disabled: { type: Boolean, default: false }, href: { type: String, default: "" }, target: { type: String, default: "_blank" } }, setup(e2, { slots: t2 }) {
...
var _ = (e2 = 'm-dialog[data-active="true"]') => {
...
var N = (e2) => e2 ? e2.getBoundingClientRect() : null;
var V = (e2) => new Promise((t2) => {
  if (!e2) return null;
...
var P = { hideTime: 200, showTime: 200, bgShow: async (e2) => {
...
var H = defineComponent({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(e2, { slots: l2 }) {
...
var A = defineComponent({ name: "MButtonGroup", props: { layout: { type: String, default: "x", validator: (e2) => ["x", "y"].includes(e2) }, size: String }, setup(e2, { slots: t2 }) {
  const { size: a2, zIndex: l2 } = x();
  return provide(w, { size: e2.size || a2, zIndex: l2 }), () => {
    var _a;
    const a3 = (_a = t2.default) == null ? void 0 : _a.call(t2);
    return createVNode("div", { class: ["m-button-group", "y" === e2.layout ? "m-button-layout-y" : "m-button-layout-x"] }, [a3]);
  };
} });
...
var q = defineComponent({ name: "MTransition", props: { onEnter: Function, onLeave: Function }, setup: (e2, t2) => () => {
...
var j = async ({ mask: e2, wrapper: t2, content: a2 }) => {
...
var D = defineComponent({ name: "MDialog", components: { MButton: k }, props: { visible: { type: Boolean, default: false }, content: { type: String, default: "" }, className: String, title: { type: String, default: "" }, cancelBtnText: { type: String, default: "" }, okBtnText: { type: String, default: "" }, okBtnProps: { type: Object, default: () => ({ type: "primary" }) }, cancelBtnProps: { type: Object, default: () => ({ type: "default" }) }, width: { type: [Number, String], default: "50%" }, height: { type: [Number, String], default: "auto" }, showClose: { type: Boolean, default: true }, maskBackgroundColor: { type: String, default: "" }, fullscreen: { type: Boolean, default: false }, escHide: { type: Boolean, default: true }, maskHide: { type: Boolean, default: true }, target: { type: [String], default: "body" }, top: { type: String, default: "center" }, _onClose: Function }, emits: ["close"], setup(e2, l2) {
  ...
  return () => {
    ...
    return createVNode(Teleport, { to: e2.target }, { default: () => [createVNode(q, { onEnter: y2, onLeave: b2 }, { default: () => [withDirectives(createVNode("div", { class: `m-dialog ${e2.className || ""}`, "data-show": e2.visible, ref: r2, style: { "--m-dialog-mask-color": e2.maskBackgroundColor } }, [createVNode("section", { class: "m-dialog-mask", ref: i2 }, null), createVNode("div", { class: "m-dialog-container", onClick: () => e2.maskHide && h2("cancel") }, [createVNode("div", { style: c2.value }, [createVNode("div", { class: "m-dialog-cover", style: u2.value }, [createVNode("div", { class: "m-dialog-content", onClick: (e3) => e3.stopPropagation() }, [createVNode("div", { class: "m-dialog-content__background", ref: o2 }, null), createVNode("section", { class: "m-dialog-content__wrapper", ref: s2, style: f2.value }, [e2.showClose && createVNode(k, { type: "text", shape: "square", size: "small", class: "m-dialog-content__close", onClick: () => h2("cancel") }, { default: () => [createVNode("svg", { fill: "currentColor", class: "icon", viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", "p-id": "5090", width: "28", height: "28" }, [createVNode("path", { d: "M504.224 470.288l207.84-207.84a16 16 0 0 1 22.608 0l11.328 11.328a16 16 0 0 1 0 22.624l-207.84 207.824 207.84 207.84a16 16 0 0 1 0 22.608l-11.328 11.328a16 16 0 0 1-22.624 0l-207.824-207.84-207.84 207.84a16 16 0 0 1-22.608 0l-11.328-11.328a16 16 0 0 1 0-22.624l207.84-207.824-207.84-207.84a16 16 0 0 1 0-22.608l11.328-11.328a16 16 0 0 1 22.624 0l207.824 207.84z" }, null)])] }), g3 || e2.title && createVNode("header", { class: "m-dialog__header" }, [createVNode("span", { class: "m-dialog-title" }, [e2.title])]), w2 || createVNode("main", { class: "m-dialog__body" }, [t2 || e2.content]), a2 || (e2.cancelBtnText || e2.okBtnText) && createVNode("footer", { class: "m-dialog__footer" }, [e2.cancelBtnText && createVNode(k, mergeProps(e2.cancelBtnProps, { onClick: () => h2("cancel") }), { default: () => [e2.cancelBtnText] }), e2.okBtnText && createVNode(k, mergeProps(e2.okBtnProps, { onClick: () => h2("ok") }), { default: () => [e2.okBtnText] })])])])])])])]), [[vShow, e2.visible]])] })] });
  };
} });
var Y = (e2) => {
...
var Z = async (e2) => {
  ...
  const o2 = createApp(D, { ...Y(e2), target: t2, _onClose: async (s3) => {
    var _a, _b;
...
var Q = defineComponent({ name: "MInput", components: { MIcon: S }, props: { value: [String, Number], modelValue: [String, Number], name: { type: String, default: "" }, placeholder: { type: String, default: "" }, type: { type: String, default: "text" }, size: String, prefix: { type: String, default: "" }, suffix: { type: String, default: "" }, prepend: { type: String, default: "" }, append: { type: String, default: "" }, clearable: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, readonly: { type: Boolean, default: false }, width: { type: [String, Number], default: "" }, autofocus: { type: Boolean, default: false }, autocomplete: { type: String, default: "off" }, maxlength: { type: [String, Number], default: "" }, minlength: { type: [String, Number], default: "" }, max: { type: [String, Number], default: "" }, min: { type: [String, Number], default: "" }, step: { type: [String, Number], default: "" }, pattern: { type: String, default: "" }, showLimitCount: { type: Boolean, default: false }, showPasswordIcon: { type: Boolean, default: false }, tabindex: [Number, String] }, emits: ["update:modelValue", "change", "focus", "blur"], exposed: ["focus", "blur"], setup(e2, { emit: l2, slots: o2, expose: s2 }) {
  ...
  return s2({ focus: () => d2(true), blur: () => d2(false) }), () => {
    ...
    const t2 = ((_a = o2 == null ? void 0 : o2.prefix) == null ? void 0 : _a.call(o2)) || e2.prefix, a2 = ((_b = o2 == null ? void 0 : o2.suffix) == null ? void 0 : _b.call(o2)) || e2.suffix, l3 = ((_c = o2 == null ? void 0 : o2.prepend) == null ? void 0 : _c.call(o2)) || e2.prepend, s3 = ((_d = o2 == null ? void 0 : o2.append) == null ? void 0 : _d.call(o2)) || e2.append, c3 = () => {
      ...
      }, onBlur: () => d2(false), onFocus: () => d2(true) }, null), e2.clearable && i2.value && createVNode("span", { class: "m-input-suffix-icon-wrapper m-clearable", onClick: () => r2("") }, [createVNode(S, { name: "close-circle" }, null)]), f2.value && createVNode("span", { onClick: g2, class: "m-input-suffix-icon-wrapper" }, [createVNode(S, { name: h2.value ? "eye" : "eye-close" }, null)]), v2.value && createVNode("span", { class: "m-input-limit-count" }, [`${((_a2 = i2.value) == null ? void 0 : _a2.length) || 0}/${e2.maxlength}`]), a2 && createVNode("div", { class: "m-input-suffix" }, [a2])]);
    };
    return l3 || s3 ? createVNode("div", { style: { width: e2.width }, class: { "m-input-wrapper": true, "has-prepend": l3, "has-append": s3 } }, [l3 && createVNode("div", { class: "m-input-prepend" }, [l3]), c3(), s3 && createVNode("div", { class: "m-input-append" }, [s3])]) : c3();
  };
} });
var U = (e2, t2, l2) => {
...
var ee = defineComponent({ name: "MInputNumber", components: { MIcon: S }, props: { modelValue: Number, min: Number, max: Number, step: Number, disabled: Boolean, controlsPosition: { type: String, default: "" }, controls: { type: Boolean, default: true }, size: String, readonly: Boolean, placeholder: String, name: String, id: String, autofocus: Boolean, tabindex: Number, prefix: String, suffix: String, precision: Number }, emits: ["update:modelValue", "change", "blur", "focus"], setup(e2, { emit: t2, expose: l2, slots: s2 }) {
  const { domRef: i2, isFocus: r2, setIsFocus: u2 } = K(), { showControl: c2, isRight: d2 } = ((e3) => ({ showControl: computed(() => !!e3.controls), isRight: computed(() => "right" === e3.controlsPosition) }))(e2), { value: p2, setValue: m2 } = G(e2, t2), { classNames: f2 } = X(e2, r2), { increase: h2, decrease: g2, decreaseDisabled: v2, increaseDisabled: y2 } = U(e2, p2, m2);
  return l2({ focus: () => u2(true), blur: () => u2(false) }), () => {
    ...
    return createVNode("div", { class: ["m-input-number", c2.value ? d2.value ? "has-right-control" : "has-control" : "", ...f2.value] }, [c2.value ? d2.value ? createVNode("div", { class: "m-input-control-right" }, [b2(), createVNode("div", { class: "m-input-right-control-wrapper" }, [createVNode("span", { class: "m-input-control-top", onClick: h2, "data-disabled": y2.value }, [t3 || createVNode(S, { name: "up" }, null)]), createVNode("span", { class: "m-input-control-bottom", "data-disabled": v2.value, onClick: g2 }, [a2 || createVNode(S, { name: "down" }, null)])])]) : createVNode("div", { class: "m-input-control-default" }, [createVNode("div", { class: "m-input-number-control-left", "data-disabled": v2.value, onClick: g2 }, [t3 || createVNode(S, { name: "minus" }, null)]), b2(), createVNode("div", { class: "m-input-number-control-right", "data-disabled": y2.value, onClick: h2 }, [a2 || createVNode(S, { name: "plus" }, null)])]) : b2()]);
  };
} });
var te = defineComponent({ name: "MTextarea", props: { modelValue: String, placeholder: String, disabled: Boolean, readonly: Boolean, maxlength: Number, minlength: Number, rows: [Number, String], cols: [Number, String], autofocus: Boolean, autocomplete: String, showLimitCount: Boolean }, emits: ["update:modelValue", "focus", "blur", "change"], setup(e2, { emit: t2 }) {
  const { domRef: l2, isFocus: o2, setIsFocus: s2 } = K(), { value: i2, setValue: r2 } = G(e2, t2), { showLimitCount: u2 } = J(e2), { classnames: c2 } = ((e3, t3, l3) => ({ classnames: computed(() => {
    const a2 = ["m-textarea"];
  ...
  return () => {
    var _a;
    return createVNode("div", { class: c2.value }, [createVNode("textarea", { class: "m-textarea-content", ref: l2, rows: e2.rows, cols: e2.cols, value: i2.value, onInput: (e3) => r2(e3.target.value), onFocus: () => s2(true), onBlur: () => s2(false), disabled: e2.disabled, readonly: e2.readonly, placeholder: e2.placeholder, maxlength: e2.maxlength, minlength: e2.minlength, autofocus: e2.autofocus, autocomplete: e2.autocomplete }, null), u2.value && createVNode("span", { class: "m-textarea-limit" }, [((_a = i2.value) == null ? void 0 : _a.length) || 0, createTextVNode("/"), e2.maxlength])]);
  };
} });
...
var le = defineComponent({ name: "MAlert", props: { type: { type: String, default: "primary" }, iconSize: { type: String, default: "24px" }, title: { type: String, default: "" }, description: { type: String, default: "" }, showClose: { type: Boolean, default: false }, showIcon: { type: Boolean, default: true }, dark: { type: Boolean, default: false } }, emits: ["close"], setup(e2, { slots: a2, emit: l2 }) {
  const o2 = ref(true), s2 = () => {
    o2.value = false, l2("close");
  };
  return () => {
    const t2 = a2.title ? a2.title() : e2.title, l3 = a2.default ? a2.default() : e2.description, i2 = a2.icon ? a2.icon() : createVNode(ae, { type: e2.type, iconSize: e2.iconSize }, null);
    return createVNode("div", { class: `m-alert m-alert-${e2.type} ${e2.dark ? "is-dark" : ""}`, style: { display: o2.value ? "block" : "none" } }, [createVNode("main", { class: "m-alert-main" }, [e2.showIcon && i2 && createVNode("div", { class: "m-alert-icon" }, [i2]), createVNode("div", { class: "m-alert-content" }, [t2 && createVNode("div", { class: "m-alert-title" }, [t2]), l3 && createVNode("div", { class: "m-alert-description" }, [l3])]), e2.showClose && createVNode("span", { class: "m-alert-close" }, [createVNode(k, { onClick: s2, rightIcon: "close", type: "text", size: "mini", shape: "circle" }, null)])])]);
  };
} });
...
var oe = defineComponent({ name: "MCheckbox", props: { size: String, label: { type: String, default: "" }, checked: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, readonly: { type: Boolean, default: false }, indeterminate: { type: Boolean, default: false }, value: { type: [String, Number], default: "" }, modelValue: { type: [String, Number, Boolean, Array], default: false } }, emits: ["update:modelValue", "change", "update:indeterminate"], setup(e2, { emit: l2, slots: o2 }) {
  ...
  return () => {
    ...
    return createVNode("div", { class: c2.value, "data-disabled": e2.disabled, "data-checked": s2.value, "data-indeterminate": r2.value, "data-value": e2.value, onClick: u2 }, [createVNode("div", { class: "m-checkbox-wrapper" }, [createVNode("span", { class: "m-checkbox-control-wrapper" }, [createVNode("div", { class: "m-checkbox-control-main" }, [createVNode("div", { class: "m-checkbox-control-inner" }, [ne({ checked: s2.value, indeterminate: r2.value })])])]), createVNode("span", { class: "m-checkbox-label" }, [t2]), createVNode("input", { type: "checkbox", class: "m-checkbox-input", checked: s2.value, disabled: e2.disabled, readonly: e2.readonly, value: e2.value }, null)])]);
  };
} });
var se = defineComponent({ name: "MAvatar", components: { MIcon: S }, props: { src: { type: String, default: "" }, size: { type: String, default: "36px" }, alt: { type: String, default: "" }, srcSet: { type: String, default: "" }, fit: { type: String, default: "cover" }, icon: { type: String, default: "" }, shape: { type: String, default: "circle" }, loading: { type: String, default: "eager" } }, emits: ["error"], setup(e2, { slots: t2, emit: a2 }) {
  const l2 = (e3) => {
    a2("error", e3);
  };
  return () => {
    const a3 = t2.icon ? t2.icon() : e2.icon ? createVNode(S, { name: e2.icon, class: "m-avatar-icon", size: String(0.6 * parseInt(e2.size)) + "px" }, null) : "", o2 = t2.default ? t2.default() : "";
...
var ie = [k, B, C, z, I, M, L, H, A, $, D, Q, S, le, oe, se, ee, te].map((e2) => (e2.install = function(t2) {
  t2.component(e2.name, e2);
}, e2));
var re = { install(e2, t2) {
