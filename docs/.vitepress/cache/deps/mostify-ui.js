...
var _ = defineComponent({ name: "MBreadcrumb", props: { separator: { type: String, default: "/" }, color: String, activeColor: String }, setup(e2, { slots: t2 }) {
  ...
  return () => {
    ...
    return createVNode("div", { class: "m-breadcrumb", style: { "--color": e2.color, "--activeColor": e2.activeColor } }, [(_b = (_a = t2 == null ? void 0 : t2.default) == null ? void 0 : _a.call(t2)) == null ? void 0 : _b.map((a2, i2) => {
      var _a2;
      return createVNode(Fragment, null, [a2, i2 >= 0 && i2 < l2.value - 1 && createVNode("span", null, [t2.separator && ((_a2 = t2.separator) == null ? void 0 : _a2.call(t2)) || e2.separator])]);
    })]);
  };
} });
var z = defineComponent({ name: "MBreadcrumbItem", props: { title: { type: String, default: "" }, disabled: Boolean }, emits: ["click"], setup(e2, { emit: t2, slots: a2 }) {
  ...
  return () => createVNode("div", { class: ["m-breadcrumb__item", e2.disabled ? "is__disabled" : ""], "data-disabled": e2.disabled, onClick: l2 }, [a2.default && a2.default() || e2.title]);
} });
...
var M = defineComponent({ name: "MDropdown", props: { placement: { type: String, default: "bottomLeft" }, trigger: { type: String, default: "click", validator: (e2) => ["hover", "click"].includes(e2) }, destroyOnHide: { type: Boolean, default: false }, disabled: Boolean, open: { type: Boolean, default: false }, toBody: { type: Boolean, default: true } }, setup(t2, { slots: l2 }) {
  ...
  return watch(() => t2.trigger, () => {
    ...
    var _a;
    return [w2.value && withDirectives(createVNode("div", { class: "m-dropdown__content m-box-shadow", ref: i2, style: { "--top": h2.top, "--left": h2.left, "pointer-events": h2.waitChange ? "none" : "all" } }, [createVNode("div", { class: "m-dropdown__body", ref: y2 }, [l2.content && ((_a = l2.content()) == null ? void 0 : _a.map((e2) => (e2.props = { ...e2.props }, e2)))])]), [[vShow, g2.value]])];
  } })]);
} });
...
var X = defineComponent({ name: "MCheckbox", props: { label: { type: String, default: "" }, checked: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, indeterminate: { type: Boolean, default: false }, value: { type: [String, Number], default: "" } }, emits: ["update:modelValue", "change", "update:checked", "update:indeterminate"], setup(t2, { emit: a2, slots: l2 }) {
  const { checked: o2, indeterminate: i2, toggle: s2 } = ((t3, a3) => {
    const l3 = ref(t3.indeterminate), n2 = ref(t3.checked);
    return { toggle: () => {
...
var G = [x, k, S, C, B, _, z, M, R, $, q, D, w, W, X].map((e2) => (e2.install = function(t2) {
