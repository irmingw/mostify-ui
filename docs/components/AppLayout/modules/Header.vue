  ...
  <header class="header">
    <div class="header_inner">
      <m-space value="24px" style="align-items: center">
        <m-space value="12px" style="align-items: center" @click="$router.push('/')">
          <Logo size="36px" />
      ...
      <div>
        <m-space value="24px" style="align-items: center">
          <m-space value="12px" style="align-items: center">
          ...
          <m-space value="4px" style="align-items: center">
            <m-dropdown placement="bottomRight">
              <m-button shape="circle" type="text" size="large">
                <svg
                  t="1725174226969"
                  class="icon"
            ...
            <m-button shape="circle" size="large" type="text" @click="openGithub">
            ...
            <m-button shape="circle" size="large" type="text">
              <svg
                viewBox="0 0 1024 1024"
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <template #header>
        <section style="padding: 8px; border-bottom: 1px solid var(--m-text-500)">
          <MInput
            size="large"
      ...
      <ul class="search_wrapper" v-else>
        <li v-for="item in list">
          <div style="display: flex; justify-content: space-between; align-items: center">
            <b style="font-size: 1.2rem; color: var(--m-text-900)">{{ item.title }}</b>
            <MButton
              type="text"
              shape="circle"
              @click="
          ...
          <div>
            <span
              style="color: var(--m-theme-600); font-size: 0.98rem; line-height: 18px"
              >{{ item.desc }}</span
            >
          </div>
        </li>
